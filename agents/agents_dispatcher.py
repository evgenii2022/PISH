...
class AgentsDispatcher:
    ...
    def remove_agent(self, entity_uri) -> bool:
        ...
        if not agent_address:
            ...
            return False
        self.scene.remove_entity_by_uri(entity_uri)
        self.reference_book.agents_entities.pop(entity)
        self.actor_system.tell(agent_address, ActorExitRequest())
        return True

    def get_agents_id(self) -> typing.List:
        """
        Возвращает список идентификаторов агентов
        :return:
        """
        result = [entity.get_uri() for entity in self.reference_book.agents_entities.keys()]
        # result = list(self.reference_book.agents_entities.keys())
        return result

    def get_agents_addresses(self) -> typing.List:
        """
        Возвращает список адресов агентов
        :return:
        """
